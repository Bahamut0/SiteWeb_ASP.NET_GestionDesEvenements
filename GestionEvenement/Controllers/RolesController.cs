...
namespace GestionEvenement.Controllers
{
    public class RolesController : Controller
    {
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            RoleEM roleAmodifier = new RoleEM();
            var config = new MapperConfiguration(cfg => cfg.CreateMap<Role, RoleEM>());
            var mapper = new Mapper(config);
            roleAmodifier = mapper.Map<RoleEM>(role);

            return View(roleAmodifier);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Type")] Role role)
        {
            if (ModelState.IsValid)
            {
